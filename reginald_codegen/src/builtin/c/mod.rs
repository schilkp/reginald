...
use crate::{error::GeneratorError, regmap::TypeBitwidth, utils::str_pad_to_length};
...
fn generate_section_header_comment(out: &mut dyn Write, title: &str) -> Result<(), GeneratorError> {
...
fn c_fitting_unsigned_type(width: TypeBitwidth) -> Result<String, GeneratorError> {
    match width {
