...
/// Example:
/// ```rust
/// # use reginald_utils::ranges_to_str;
/// # use reginald_utils::RangeStyle;
/// assert_eq!(ranges_to_str(&vec![0..=2, 4..=4], RangeStyle::Rust),          "0..3, 4");
/// assert_eq!(ranges_to_str(&vec![0..=2, 4..=4], RangeStyle::RustInclusive), "0..=2, 4");
/// assert_eq!(ranges_to_str(&vec![0..=2, 4..=4], RangeStyle::Verilog)      , "2:0, 4");
/// ```
pub fn ranges_to_str<T>(i: &[RangeInclusive<T>], style: RangeStyle) -> String
where
    T: Ord + From<u8> + Add<T, Output = T> + Eq + Copy + Display,
{
...
pub struct Transform {
    pub shift: Option<(ShiftDirection, usize)>,
    pub mask: u8,
}
...
pub fn field_to_packed_byte_transform(
    ...
    field_pos: usize,
    packed_byte: usize,
    packed_width_bytes: usize,
) -> Option<Transform> {
    // Mask to be applied to the field value once shifted into place:
    let mask = (unpos_field_mask << field_pos).get_byte(endian, packed_byte, packed_width_bytes);
    if mask == 0 {
        return None;
    }
    ...
    match usize::cmp(&field_pos, &byte_lsb_pos) {
...
pub fn field_byte_to_packed_byte_transform(
    ...
    let field_mask = unpos_field_mask.get_byte(endian, field_byte, field_byte_width);
    ...
    field_to_packed_byte_transform(
        endian,
        &Bits::from_uint(field_mask.into()),
        field_pos,
        packed_byte,
        packed_width_bytes,
    )
...
mod tests {
    ...
    fn check_field_to_packed_byte_transform(
        ...
        let unpos_mask = field_mask.unpositioned();
        let field_pos = field_mask.lsb_pos();
    ...
    fn test_field_to_packed_byte_transform() {
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0x0F), 1, expect_le);
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0x18), 1, expect_le);
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0xAF00), 2, expect_le);
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0x0AF0), 2, expect_le);
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0x0A80), 2, expect_le);
        ...
        check_field_to_packed_byte_transform(&Bits::from_uint(0x0003FF80), 4, expect_le);
    }

    #[test]
    fn test_field_byte_to_packed_byte_transform() {
        // positioned field: 0b0011_1111_1111_0000
        let field_mask_unpos = Bits::from_uint(0x3ff);
        let field_pos = 4;
    ...
    fn test_packed_byte_to_field_transform() {
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0x0F), 1, expect_le);
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0x18), 1, expect_le);
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0xAF00), 2, expect_le);
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0x0AF0), 2, expect_le);
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0x0A80), 2, expect_le);
        ...
        check_packed_byte_to_field_transform(&Bits::from_uint(0x0003FF80), 4, expect_le);
    }
